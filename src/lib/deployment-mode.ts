...
export type DeploymentMode = "full" | "demo";
...
export function deploymentMode(environment: NodeJS.ProcessEnv = process.env): DeploymentMode {
  ...
  if (value === "full" || value === "demo") return value;
  if (environment.NODE_ENV === "production") {
    throw new Error("DEPLOYMENT_MODE deve ser explicitamente definido como full ou demo.");
  }
  return "full";
}
