...
export default async function MonitoringPage() {
  ...
  return <AdminShell><main className="mx-auto max-w-7xl px-4 py-10">
    <div className="flex flex-wrap justify-between gap-4"><div><p className="text-xs font-black uppercase tracking-[.2em] text-amber-700">Fontes oficiais</p><h1 className="mt-2 text-3xl font-black text-emerald-950">Monitoramento</h1></div><div className="flex gap-3"><Link href="/admin/monitoramento/alteracoes" className="rounded-xl border border-emerald-900 px-4 py-3 font-black text-emerald-900">Alterações pendentes</Link>{!demo && <Link href="/admin/monitoramento/novo" className="rounded-xl bg-emerald-900 px-4 py-3 font-black text-white">Novo monitor</Link>}</div></div>
